...
import { staticProjects, PortfolioProject } from '@/lib/staticProjects';
...
export function PortfolioClient() {
  ...
  const categories = useMemo(() => {
    return ["Alle", ...Array.from(new Set(projects.map(p => p.category)))];
  }, [projects]);
  ...
  }, [projects, activeCategory, activeQuality]);
