        ...
        <div className="flex flex-col gap-6">
           {[
             ...
             <div key={i} className="bg-white border border-[#091426] p-6 shadow-[4px_4px_0px_0px_#091426] flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <button onClick={handleApplyClick} className="bg-[#091426] text-white font-bold px-6 py-3 border border-[#091426] uppercase whitespace-nowrap hover:bg-[#fd761a] transition-colors mt-4 md:mt-0 shadow-[4px_4px_0px_0px_#fd761a] hover:translate-y-1 hover:shadow-none">Jetzt Bewerben</button>
             </div>
           ))}
        </div>
      </section>
